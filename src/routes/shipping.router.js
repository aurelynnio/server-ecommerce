 ...
 */
router.post('/', validate(createTemplateValidator), shippingController.createTemplate);
 ...
 */
router.put('/:templateId', validate(updateTemplateValidator), shippingController.updateTemplate);
