...
module.exports = {
  ...
  orderIdParamValidator: Joi.object({ orderId: objectId.required() }),
  getOrdersQueryValidator: Joi.object({
    ...pagination,
    status: Joi.string().valid("pending", "confirmed", "processing", "shipped", "delivered", "cancelled", "returned"),
