...
describe("PermissionService", () => {
  describe("_normalizeRoles()", () => {
    ...
    it("should return array as-is", () => {
      expect(permissionService._normalizeRoles(["admin", "user"])).toEqual([
        "admin",
        "user",
      ]);
    });
    ...
    it("should filter falsy values", () => {
      expect(permissionService._normalizeRoles([null, "user", ""])).toEqual([
        "user",
      ]);
    });
  ...
  describe("_getPermissionsForRoles()", () => {
    ...
    it("should merge multiple roles without duplicates", () => {
      const perms = permissionService._getPermissionsForRoles([
        "user",
        "seller",
      ]);
  ...
  describe("hasPermission()", () => {
    ...
    it("should return false for null permission", () => {
      expect(permissionService.hasPermission({ role: "user" }, null)).toBe(
        false,
      );
    });
    ...
    it("should grant admin any valid permission", () => {
      ...
      expect(permissionService.hasPermission(admin, "product:create")).toBe(
        true,
      );
    ...
    it("should check exact permission", () => {
      ...
      expect(permissionService.hasPermission(user, "product:create")).toBe(
        false,
      );
    });
  ...
  describe("hasAnyPermission()", () => {
    ...
    it("should return false for null user", () => {
      expect(permissionService.hasAnyPermission(null, ["product:read"])).toBe(
        false,
      );
    });

    it("should return false for empty permissions array", () => {
      expect(permissionService.hasAnyPermission({ role: "user" }, [])).toBe(
        false,
      );
    });
  });
