...
describe("AuthMiddleware Logic", () => {
  ...
  describe("roleFlattening", () => {
    ...
    it("should flatten mixed", () => {
      expect(flattenRoles("admin", ["user", "seller"])).toEqual([
        "admin",
        "user",
        "seller",
      ]);
  ...
  describe("userRolesExtraction", () => {
    ...
    it("should extract role array", () => {
      expect(extractUserRoles({ role: ["admin", "user"] })).toEqual([
        "admin",
        "user",
      ]);
    });
    ...
    it("should merge role and roles", () => {
      expect(extractUserRoles({ role: "admin", roles: "seller" })).toEqual([
        "admin",
        "seller",
      ]);
    });
    ...
    it("should merge role and roles arrays", () => {
      expect(
        extractUserRoles({ role: ["admin"], roles: ["seller", "user"] }),
      ).toEqual(["admin", "seller", "user"]);
    });
